INSERT INTO BIKES
VALUES ('01', 'AEROAD CF SLX DISC 9.0 DI2',
        ...
        '7433', 'Canyon', 'Aero Road Bike', 'New', 450, 0, false);

INSERT INTO BIKES
VALUES ('02', 'Strive CFR 9.0 LTD',
        'Speed incarnate: The flagship carbon frame of the Strive CFR 9.0 LTD comes equipped with top-of-the-line components to ensure the highest levels of performance. Add in the Shapeshifter technology and your rivals won’t stand a chance. From Whistler to Finale Ligure,the Strive CFR 9.0 LTD was created to fight for seconds at the most challenging stops of the Enduro World Series. Its Shapeshifter system and excellent components come together to guarantee that you’re always in the hunt for a new personal best.',
        '8188', 'Canyon', 'Mountain Enduro Bike', 'New', 1000, 0, false);

INSERT INTO BIKES
VALUES ('03', 'Speedmax CF SLX 9.0 LTD',
        ...
        '9788', 'Canyon', 'Triathlon Bike', 'New', 1000, 0, false);
